...
/**
 * @brief Ordena os índices em ordem decrescente para evitar problemas ao remover
 * @note Auxiliar da remover_carta
 * 
 * @param posi_excluir >>> posições a serem excluídas 
 * @param num_excluir >>> quantidade de posicoes a serem excluídas
 */
...
/**
 * @brief Remove as cartas do vetor de acordo com as posições a serem excluídas
 * 
 * @param vetor >>> vetor de cartas
 * @param quantd_cartas_vetor >>> quantidade de cartas no vetor
 * @param posicoes_excluir >>> posições a serem excluídas
 * @param quantd_excluir >>> quantidade de posições a serem excluídas
 */
